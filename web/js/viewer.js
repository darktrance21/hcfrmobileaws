...
function getViewerConfiguration() {
  return {
    ...
    documentProperties: {
      ...
      closeButton2: document.getElementById('documentPropertiesClose2'),
      fields: {
    ...
    errorWrapper: {
      ...
      closeButton2: document.getElementById('errorClose'),
...
var defaultOptions = {
  ...
  defaultUrl: {
    value: '../pdf/Medical-Operations/medical-protocol-2017.pdf',
