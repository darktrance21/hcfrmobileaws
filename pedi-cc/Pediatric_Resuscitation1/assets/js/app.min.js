...
this.activeTarget=b,this.clear();var c=this.selector+'[data-target="'+b+'"],'+this.selector+'[href="'+b+'"]',d=a(c).parents("li").addClass("active");d.parent(".dropdown-menu").length&&(d=d.closest("li.dropdown").addClass("active")),d.trigger("activate.bs.scrollspy")},b.prototype.clear=function(){a(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};var d=a.fn.scrollspy;a.fn.scrollspy=c,a.fn.scrollspy.Constructor=b,a.fn.scrollspy.noConflict=function(){return a.fn.scrollspy=d,this},a(window).on("load.bs.scrollspy.data-api",function(){a('[data-spy="scroll"]').each(function(){var b=a(this);c.call(b,b.data())})})}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.tab");e||d.data("bs.tab",e=new c(this)),"string"==typeof b&&e[b]()})}var c=function(b){this.element=a(b)};c.VERSION="3.3.7",c.TRANSITION_DURATION=150,c.prototype.show=function(){var b=this.element,c=b.closest("ul:not(.dropdown-menu)"),d=b.data("target");if(d||(d=b.attr("href"),d=d&&d.replace(/.*(?=#[^\s]*$)/,"")),!b.parent("li").hasClass("active")){var e=c.find(".active:last a"),f=a.Event("hide.bs.tab",{relatedTarget:b[0]}),g=a.Event("show.bs.tab",{relatedTarget:e[0]});if(e.trigger(f),b.trigger(g),!g.isDefaultPrevented()&&!f.isDefaultPrevented()){var h=a(d);this.activate(b.closest("li"),c),this.activate(h,h.parent(),function(){e.trigger({type:"hidden.bs.tab",relatedTarget:b[0]}),b.trigger({type:"shown.bs.tab",relatedTarget:e[0]})})}}},c.prototype.activate=function(b,d,e){function f(){g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),b.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),h?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade"),b.parent(".dropdown-menu").length&&b.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),e&&e()}var g=d.find("> .active"),h=e&&a.support.transition&&(g.length&&g.hasClass("fade")||!!d.find("> .fade").length);g.length&&h?g.one("bsTransitionEnd",f).emulateTransitionEnd(c.TRANSITION_DURATION):f(),g.removeClass("in")};var d=a.fn.tab;a.fn.tab=b,a.fn.tab.Constructor=c,a.fn.tab.noConflict=function(){return a.fn.tab=d,this};var e=function(c){c.preventDefault(),b.call(a(this),"show")};a(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',e).on("click.bs.tab.data-api",'[data-toggle="pill"]',e)}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.affix"),f="object"==typeof b&&b;e||d.data("bs.affix",e=new c(this,f)),"string"==typeof b&&e[b]()})}var c=function(b,d){this.options=a.extend({},c.DEFAULTS,d),this.$target=a(this.options.target).on("scroll.bs.affix.data-api",a.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",a.proxy(this.checkPositionWithEventLoop,this)),this.$element=a(b),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};c.VERSION="3.3.7",c.RESET="affix affix-top affix-bottom",c.DEFAULTS={offset:0,target:window},c.prototype.getState=function(a,b,c,d){var e=this.$target.scrollTop(),f=this.$element.offset(),g=this.$target.height();if(null!=c&&"top"==this.affixed)return e<c&&"top";if("bottom"==this.affixed)return null!=c?!(e+this.unpin<=f.top)&&"bottom":!(e+g<=a-d)&&"bottom";var h=null==this.affixed,i=h?e:f.top,j=h?g:b;return null!=c&&e<=c?"top":null!=d&&i+j>=a-d&&"bottom"},c.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(c.RESET).addClass("affix");var a=this.$target.scrollTop(),b=this.$element.offset();return this.pinnedOffset=b.top-a},c.prototype.checkPositionWithEventLoop=function(){setTimeout(a.proxy(this.checkPosition,this),1)},c.prototype.checkPosition=function(){if(this.$element.is(":visible")){var b=this.$element.height(),d=this.options.offset,e=d.top,f=d.bottom,g=Math.max(a(document).height(),a(document.body).height());"object"!=typeof d&&(f=e=d),"function"==typeof e&&(e=d.top(this.$element)),"function"==typeof f&&(f=d.bottom(this.$element));var h=this.getState(g,b,e,f);if(this.affixed!=h){null!=this.unpin&&this.$element.css("top","");var i="affix"+(h?"-"+h:""),j=a.Event(i+".bs.affix");if(this.$element.trigger(j),j.isDefaultPrevented())return;this.affixed=h,this.unpin="bottom"==h?this.getPinnedOffset():null,this.$element.removeClass(c.RESET).addClass(i).trigger(i.replace("affix","affixed")+".bs.affix")}"bottom"==h&&this.$element.offset({top:g-b-f})}};var d=a.fn.affix;a.fn.affix=b,a.fn.affix.Constructor=c,a.fn.affix.noConflict=function(){return a.fn.affix=d,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var c=a(this),d=c.data();d.offset=d.offset||{},null!=d.offsetBottom&&(d.offset.bottom=d.offsetBottom),null!=d.offsetTop&&(d.offset.top=d.offsetTop),b.call(c,d)})})}(jQuery);function recalc_onclick(e){ssc.recalcSource=e,co.XLEW_1_1_2=eeparseFloatV(document.getElementById("XLEW_1_1_2").value),co.XLEW_1_3_2=eeparseFloatV(document.getElementById("XLEW_1_3_2").value),co.XLEW_1_4_2=eeparseFloatV(document.getElementById("XLEW_1_4_2").value),co.XLEW_1_9_2=eeparseFloat(document.getElementById("XLEW_1_9_2").value),co.XLEW_1_9_4=eeparseFloat(document.getElementById("XLEW_1_9_4").value),co.XLEW_1_10_2=eeparseFloat(document.getElementById("XLEW_1_10_2").value),co.XLEW_1_10_4=eeparseFloat(document.getElementById("XLEW_1_10_4").value),co.XLEW_1_11_2=eeparseFloat(document.getElementById("XLEW_1_11_2").value),co.XLEW_1_11_4=eeparseFloat(document.getElementById("XLEW_1_11_4").value),co.XLEW_1_13_2=eeparseFloat(document.getElementById("XLEW_1_13_2").value),co.XLEW_1_13_4=eeparseFloat(document.getElementById("XLEW_1_13_4").value),co.XLEW_1_14_2=eeparseFloat(document.getElementById("XLEW_1_14_2").value),co.XLEW_1_14_4=eeparseFloat(document.getElementById("XLEW_1_14_4").value),co.XLEW_1_15_2=eeparseFloat(document.getElementById("XLEW_1_15_2").value),co.XLEW_1_15_4=eeparseFloat(document.getElementById("XLEW_1_15_4").value),co.XLEW_1_16_2=eeparseFloat(document.getElementById("XLEW_1_16_2").value),co.XLEW_1_16_4=eeparseFloat(document.getElementById("XLEW_1_16_4").value),co.XLEW_1_17_2=eeparseFloat(document.getElementById("XLEW_1_17_2").value),co.XLEW_1_17_4=eeparseFloat(document.getElementById("XLEW_1_17_4").value),co.XLEW_1_18_2=eeparseFloat(document.getElementById("XLEW_1_18_2").value),co.XLEW_1_18_4=eeparseFloat(document.getElementById("XLEW_1_18_4").value),co.XLEW_1_20_2=eeparseFloat(document.getElementById("XLEW_1_20_2").value),co.XLEW_1_20_4=eeparseFloat(document.getElementById("XLEW_1_20_4").value),co.XLEW_1_21_2=eeparseFloat(document.getElementById("XLEW_1_21_2").value),co.XLEW_1_21_4=eeparseFloat(document.getElementById("XLEW_1_21_4").value),co.XLEW_1_22_2=eeparseFloat(document.getElementById("XLEW_1_22_2").value),co.XLEW_1_22_4=eeparseFloat(document.getElementById("XLEW_1_22_4").value),co.XLEW_1_23_2=eeparseFloat(document.getElementById("XLEW_1_23_2").value),co.XLEW_1_23_4=eeparseFloat(document.getElementById("XLEW_1_23_4").value),co.XLEW_1_24_2=eeparseFloat(document.getElementById("XLEW_1_24_2").value),co.XLEW_1_24_4=eeparseFloatV(document.getElementById("XLEW_1_24_4").value),co.XLEW_1_25_2=eeparseFloat(document.getElementById("XLEW_1_25_2").value),co.XLEW_1_25_4=eeparseFloatV(document.getElementById("XLEW_1_25_4").value),co.XLEW_1_26_2=eeparseFloat(document.getElementById("XLEW_1_26_2").value),co.XLEW_1_26_4=eeparseFloatV(document.getElementById("XLEW_1_26_4").value),co.XLEW_1_27_2=eeparseFloat(document.getElementById("XLEW_1_27_2").value),co.XLEW_1_27_4=eeparseFloatV(document.getElementById("XLEW_1_27_4").value),co.XLEW_1_28_2=eeparseFloat(document.getElementById("XLEW_1_28_2").value),co.XLEW_1_28_4=eeparseFloatV(document.getElementById("XLEW_1_28_4").value),co.XLEW_1_29_2=eeparseFloat(document.getElementById("XLEW_1_29_2").value),co.XLEW_1_29_4=eeparseFloatV(document.getElementById("XLEW_1_29_4").value),co.XLEW_1_30_2=eeparseFloat(document.getElementById("XLEW_1_30_2").value),co.XLEW_1_30_4=eeparseFloatV(document.getElementById("XLEW_1_30_4").value),co.XLEW_1_31_2=eeparseFloat(document.getElementById("XLEW_1_31_2").value),co.XLEW_1_31_4=eeparseFloatV(document.getElementById("XLEW_1_31_4").value),co.XLEW_1_32_2=eeparseFloat(document.getElementById("XLEW_1_32_2").value),co.XLEW_1_32_4=eeparseFloat(document.getElementById("XLEW_1_32_4").value),co.XLEW_1_33_2=eeparseFloat(document.getElementById("XLEW_1_33_2").value),co.XLEW_1_33_4=eeparseFloat(document.getElementById("XLEW_1_33_4").value),co.XLEW_1_34_2=eeparseFloat(document.getElementById("XLEW_1_34_2").value),co.XLEW_1_34_4=eeparseFloat(document.getElementById("XLEW_1_34_4").value),co.XLEW_1_35_2=eeparseFloat(document.getElementById("XLEW_1_35_2").value),co.XLEW_1_36_2=eeparseFloat(document.getElementById("XLEW_1_36_2").value),co.XLEW_1_36_4=eeparseFloatV(document.getElementById("XLEW_1_36_4").value),co.XLEW_1_37_2=eeparseFloat(document.getElementById("XLEW_1_37_2").value),co.XLEW_1_37_4=eeparseFloat(document.getElementById("XLEW_1_37_4").value),co.XLEW_1_38_2=eeparseFloat(document.getElementById("XLEW_1_38_2").value),co.XLEW_1_38_4=eeparseFloat(document.getElementById("XLEW_1_38_4").value),co.XLEW_1_39_2=eeparseFloat(document.getElementById("XLEW_1_39_2").value),co.XLEW_1_39_4=eeparseFloat(document.getElementById("XLEW_1_39_4").value),co.XLEW_1_40_2=eeparseFloat(document.getElementById("XLEW_1_40_2").value),co.XLEW_1_40_4=eeparseFloat(document.getElementById("XLEW_1_40_4").value),co.XLEW_1_41_2=eeparseFloat(document.getElementById("XLEW_1_41_2").value),co.XLEW_1_41_4=eeparseFloat(document.getElementById("XLEW_1_41_4").value),co.XLEW_1_42_2=eeparseFloat(document.getElementById("XLEW_1_42_2").value),co.XLEW_1_42_4=eeparseFloat(document.getElementById("XLEW_1_42_4").value),co.XLEW_1_43_2=eeparseFloat(document.getElementById("XLEW_1_43_2").value),co.XLEW_1_43_4=eeparseFloat(document.getElementById("XLEW_1_43_4").value),co.XLEW_1_44_2=eeparseFloat(document.getElementById("XLEW_1_44_2").value),co.XLEW_1_44_4=eeparseFloat(document.getElementById("XLEW_1_44_4").value),co.XLEW_1_45_2=eeparseFloat(document.getElementById("XLEW_1_45_2").value),co.XLEW_1_45_4=eeparseFloat(document.getElementById("XLEW_1_45_4").value),co.XLEW_1_46_2=eeparseFloat(document.getElementById("XLEW_1_46_2").value),co.XLEW_1_46_4=eeparseFloat(document.getElementById("XLEW_1_46_4").value),co.XLEW_1_47_2=eeparseFloat(document.getElementById("XLEW_1_47_2").value),co.XLEW_1_47_4=eeparseFloat(document.getElementById("XLEW_1_47_4").value),co.XLEW_1_48_2=eeparseFloat(document.getElementById("XLEW_1_48_2").value),co.XLEW_1_48_4=eeparseFloat(document.getElementById("XLEW_1_48_4").value),co.XLEW_1_49_2=eeparseFloat(document.getElementById("XLEW_1_49_2").value),co.XLEW_1_49_4=eeparseFloat(document.getElementById("XLEW_1_49_4").value),co.XLEW_1_50_2=eeparseFloat(document.getElementById("XLEW_1_50_2").value),co.XLEW_1_50_4=eeparseFloat(document.getElementById("XLEW_1_50_4").value),co.XLEW_1_51_2=eeparseFloat(document.getElementById("XLEW_1_51_2").value),co.XLEW_1_51_4=eeparseFloat(document.getElementById("XLEW_1_51_4").value),co.XLEW_1_52_2=eeparseFloat(document.getElementById("XLEW_1_52_2").value),co.XLEW_1_52_4=eeparseFloat(document.getElementById("XLEW_1_52_4").value),co.XLEW_1_53_2=eeparseFloat(document.getElementById("XLEW_1_53_2").value),co.XLEW_1_53_4=eeparseFloat(document.getElementById("XLEW_1_53_4").value),co.XLEW_1_54_2=eeparseFloat(document.getElementById("XLEW_1_54_2").value),co.XLEW_1_54_4=eeparseFloat(document.getElementById("XLEW_1_54_4").value),co.XLEW_1_55_2=eeparseFloat(document.getElementById("XLEW_1_55_2").value),co.XLEW_1_55_4=eeparseFloat(document.getElementById("XLEW_1_55_4").value),co.XLEW_1_56_2=eeparseFloat(document.getElementById("XLEW_1_56_2").value),co.XLEW_1_56_4=eeparseFloat(document.getElementById("XLEW_1_56_4").value),co.XLEW_1_57_2=eeparseFloat(document.getElementById("XLEW_1_57_2").value),co.XLEW_1_57_4=eeparseFloat(document.getElementById("XLEW_1_57_4").value),co.XLEW_1_58_2=eeparseFloat(document.getElementById("XLEW_1_58_2").value),co.XLEW_1_58_4=eeparseFloat(document.getElementById("XLEW_1_58_4").value),co.XLEW_1_59_2=eeparseFloat(document.getElementById("XLEW_1_59_2").value),co.XLEW_1_59_4=eeparseFloat(document.getElementById("XLEW_1_59_4").value),co.XLEW_1_60_2=eeparseFloat(document.getElementById("XLEW_1_60_2").value),co.XLEW_1_60_4=eeparseFloat(document.getElementById("XLEW_1_60_4").value),co.XLEW_1_61_2=eeparseFloat(document.getElementById("XLEW_1_61_2").value),co.XLEW_1_61_4=eeparseFloat(document.getElementById("XLEW_1_61_4").value),co.XLEW_1_62_2=eeparseFloat(document.getElementById("XLEW_1_62_2").value),co.XLEW_1_62_4=eeparseFloat(document.getElementById("XLEW_1_62_4").value),co.XLEW_1_63_2=eeparseFloat(document.getElementById("XLEW_1_63_2").value),co.XLEW_1_63_4=eeparseFloat(document.getElementById("XLEW_1_63_4").value),co.XLEW_1_64_2=eeparseFloat(document.getElementById("XLEW_1_64_2").value),co.XLEW_1_64_4=eeparseFloat(document.getElementById("XLEW_1_64_4").value),co.XLEW_1_65_2=eeparseFloat(document.getElementById("XLEW_1_65_2").value),co.XLEW_1_65_4=eeparseFloat(document.getElementById("XLEW_1_65_4").value),co.XLEW_1_66_2=eeparseFloat(document.getElementById("XLEW_1_66_2").value),co.XLEW_1_66_4=eeparseFloat(document.getElementById("XLEW_1_66_4").value),co.XLEW_1_67_2=eeparseFloat(document.getElementById("XLEW_1_67_2").value),co.XLEW_1_67_4=eeparseFloat(document.getElementById("XLEW_1_67_4").value),co.XLEW_1_69_2=eeparseFloat(document.getElementById("XLEW_1_69_2").value),co.XLEW_1_69_4=eeparseFloat(document.getElementById("XLEW_1_69_4").value),co.XLEW_1_70_2=eeparseFloat(document.getElementById("XLEW_1_70_2").value),co.XLEW_1_70_4=eeparseFloat(document.getElementById("XLEW_1_70_4").value),co.XLEW_1_71_2=eeparseFloat(document.getElementById("XLEW_1_71_2").value),co.XLEW_1_71_4=eeparseFloat(document.getElementById("XLEW_1_71_4").value),co.XLEW_1_72_2=eeparseFloat(document.getElementById("XLEW_1_72_2").value),co.XLEW_1_72_4=eeparseFloat(document.getElementById("XLEW_1_72_4").value),co.XLEW_1_73_2=eeparseFloat(document.getElementById("XLEW_1_73_2").value),co.XLEW_1_73_4=eeparseFloat(document.getElementById("XLEW_1_73_4").value),co.XLEW_1_74_2=eeparseFloat(document.getElementById("XLEW_1_74_2").value),co.XLEW_1_74_4=eeparseFloat(document.getElementById("XLEW_1_74_4").value),co.XLEW_1_75_2=eeparseFloat(document.getElementById("XLEW_1_75_2").value),co.XLEW_1_75_4=eeparseFloat(document.getElementById("XLEW_1_75_4").value),co.XLEW_1_76_2=eeparseFloat(document.getElementById("XLEW_1_76_2").value),co.XLEW_1_76_4=eeparseFloat(document.getElementById("XLEW_1_76_4").value),co.XLEW_1_77_2=eeparseFloat(document.getElementById("XLEW_1_77_2").value),co.XLEW_1_77_4=eeparseFloat(document.getElementById("XLEW_1_77_4").value),co.XLEW_1_78_2=eeparseFloat(document.getElementById("XLEW_1_78_2").value),co.XLEW_1_78_4=eeparseFloat(document.getElementById("XLEW_1_78_4").value),co.XLEW_1_79_2=eeparseFloat(document.getElementById("XLEW_1_79_2").value),co.XLEW_1_79_4=eeparseFloat(document.getElementById("XLEW_1_79_4").value),co.XLEW_1_80_2=eeparseFloat(document.getElementById("XLEW_1_80_2").value),co.XLEW_1_80_4=eeparseFloat(document.getElementById("XLEW_1_80_4").value),co.XLEW_1_81_2=eeparseFloat(document.getElementById("XLEW_1_81_2").value),co.XLEW_1_81_4=eeparseFloat(document.getElementById("XLEW_1_81_4").value),co.XLEW_1_82_2=eeparseFloat(document.getElementById("XLEW_1_82_2").value),co.XLEW_1_82_4=eeparseFloat(document.getElementById("XLEW_1_82_4").value),co.XLEW_1_83_2=eeparseFloat(document.getElementById("XLEW_1_83_2").value),co.XLEW_1_83_4=eeparseFloat(document.getElementById("XLEW_1_83_4").value),co.XLEW_1_84_2=eeparseFloat(document.getElementById("XLEW_1_84_2").value),co.XLEW_1_84_4=eeparseFloat(document.getElementById("XLEW_1_84_4").value),co.XLEW_1_85_2=eeparseFloat(document.getElementById("XLEW_1_85_2").value),co.XLEW_1_87_2=eeparseFloat(document.getElementById("XLEW_1_87_2").value),co.XLEW_1_87_4=eeparseFloat(document.getElementById("XLEW_1_87_4").value),co.XLEW_1_88_2=eeparseFloat(document.getElementById("XLEW_1_88_2").value),co.XLEW_1_88_4=eeparseFloat(document.getElementById("XLEW_1_88_4").value),co.XLEW_1_89_2=eeparseFloat(document.getElementById("XLEW_1_89_2").value),co.XLEW_1_89_4=eeparseFloat(document.getElementById("XLEW_1_89_4").value),co.XLEW_1_90_2=eeparseFloat(document.getElementById("XLEW_1_90_2").value),co.XLEW_1_90_4=eeparseFloat(document.getElementById("XLEW_1_90_4").value),co.XLEW_1_91_2=eeparseFloat(document.getElementById("XLEW_1_91_2").value),co.XLEW_1_91_4=eeparseFloat(document.getElementById("XLEW_1_91_4").value),co.XLEW_1_92_2=eeparseFloat(document.getElementById("XLEW_1_92_2").value),co.XLEW_1_92_4=eeparseFloat(document.getElementById("XLEW_1_92_4").value),co.XLEW_1_93_2=eeparseFloat(document.getElementById("XLEW_1_93_2").value),co.XLEW_1_93_4=eeparseFloat(document.getElementById("XLEW_1_93_4").value),co.XLEW_1_94_2=eeparseFloat(document.getElementById("XLEW_1_94_2").value),co.XLEW_1_94_4=eeparseFloat(document.getElementById("XLEW_1_94_4").value),co.XLEW_1_95_2=eeparseFloat(document.getElementById("XLEW_1_95_2").value),co.XLEW_1_95_4=eeparseFloat(document.getElementById("XLEW_1_95_4").value),co.XLEW_1_96_2=eeparseFloat(document.getElementById("XLEW_1_96_2").value),co.XLEW_1_96_4=eeparseFloat(document.getElementById("XLEW_1_96_4").value),co.XLEW_1_97_2=eeparseFloat(document.getElementById("XLEW_1_97_2").value),co.XLEW_1_97_4=eeparseFloat(document.getElementById("XLEW_1_97_4").value),co.XLEW_1_98_2=eeparseFloat(document.getElementById("XLEW_1_98_2").value),co.XLEW_1_98_4=eeparseFloat(document.getElementById("XLEW_1_98_4").value),co.XLEW_1_99_2=eeparseFloat(document.getElementById("XLEW_1_99_2").value),co.XLEW_1_99_4=eeparseFloat(document.getElementById("XLEW_1_99_4").value),co.XLEW_1_100_2=eeparseFloat(document.getElementById("XLEW_1_100_2").value),co.XLEW_1_100_4=eeparseFloat(document.getElementById("XLEW_1_100_4").value),co.XLEW_1_101_2=eeparseFloat(document.getElementById("XLEW_1_101_2").value),co.XLEW_1_101_4=eeparseFloat(document.getElementById("XLEW_1_101_4").value),co.XLEW_1_102_2=eeparseFloat(document.getElementById("XLEW_1_102_2").value),co.XLEW_1_102_4=eeparseFloat(document.getElementById("XLEW_1_102_4").value),co.XLEW_1_103_2=eeparseFloat(document.getElementById("XLEW_1_103_2").value),co.XLEW_1_103_4=eeparseFloat(document.getElementById("XLEW_1_103_4").value),co.XLEW_1_104_2=eeparseFloat(document.getElementById("XLEW_1_104_2").value),co.XLEW_1_104_4=eeparseFloat(document.getElementById("XLEW_1_104_4").value),co.XLEW_1_105_2=eeparseFloat(document.getElementById("XLEW_1_105_2").value),co.XLEW_1_105_4=eeparseFloat(document.getElementById("XLEW_1_105_4").value),co.XLEW_1_106_2=eeparseFloat(document.getElementById("XLEW_1_106_2").value),co.XLEW_1_106_4=eeparseFloat(document.getElementById("XLEW_1_106_4").value),co.XLEW_1_107_2=eeparseFloat(document.getElementById("XLEW_1_107_2").value),co.XLEW_1_107_4=eeparseFloat(document.getElementById("XLEW_1_107_4").value),calc(co),void 0!==ssc&&void 0!==ssc.realtimesync&&void 0!==ssc.realtimesync.connection&&1==ssc.realtimesync.connection.readyState?ssc.realtimesync.coUpdate(co,e):void 0!==ssc&&void 0!==ssc.realtimesync&&ssc.realtimesync.wsUrl&&ssc.realtimesync.IsCloseByError&&!ssc.realtimesync.IsErrorMsgDialogShown&&(alert("Realtime-Sync is Disconnected, This Form will not save in server and will not collaborate with your partner.")||(ssc.realtimesync.IsErrorMsgDialogShown=!0)),document.getElementById("XLEW_1_4_5").value=eeisnumber(co.XLEW_1_4_5)?eedisplayFloat(co.XLEW_1_4_5):co.XLEW_1_4_5,document.getElementById("XLEW_1_9_6").value=eedisplayFloat(co.XLEW_1_9_6),document.getElementById("XLEW_1_10_6").value=eedisplayFloat(co.XLEW_1_10_6),document.getElementById("XLEW_1_11_6").value=eedisplayFloat(co.XLEW_1_11_6),document.getElementById("XLEW_1_13_6").value=eedisplayFloat(co.XLEW_1_13_6),document.getElementById("XLEW_1_14_6").value=eedisplayFloat(co.XLEW_1_14_6),document.getElementById("XLEW_1_15_6").value=eedisplayFloat(co.XLEW_1_15_6),document.getElementById("XLEW_1_16_6").value=eedisplayFloat(co.XLEW_1_16_6),document.getElementById("XLEW_1_17_6").value=eedisplayFloat(co.XLEW_1_17_6),document.getElementById("XLEW_1_18_6").value=eedisplayFloat(co.XLEW_1_18_6),document.getElementById("XLEW_1_20_6").value=eedisplayFloat(co.XLEW_1_20_6),document.getElementById("XLEW_1_21_6").value=eedisplayFloat(co.XLEW_1_21_6),document.getElementById("XLEW_1_22_6").value=eedisplayFloat(co.XLEW_1_22_6),document.getElementById("XLEW_1_23_6").value=eedisplayFloat(co.XLEW_1_23_6),document.getElementById("XLEW_1_24_6").value=eeisnumber(co.XLEW_1_24_6)?eedisplayFloat(co.XLEW_1_24_6):co.XLEW_1_24_6,document.getElementById("XLEW_1_25_6").value=eeisnumber(co.XLEW_1_25_6)?eedisplayFloat(co.XLEW_1_25_6):co.XLEW_1_25_6,document.getElementById("XLEW_1_26_6").value=eeisnumber(co.XLEW_1_26_6)?eedisplayFloat(co.XLEW_1_26_6):co.XLEW_1_26_6,document.getElementById("XLEW_1_27_6").value=eeisnumber(co.XLEW_1_27_6)?eedisplayFloat(co.XLEW_1_27_6):co.XLEW_1_27_6,document.getElementById("XLEW_1_28_6").value=eeisnumber(co.XLEW_1_28_6)?eedisplayFloat(co.XLEW_1_28_6):co.XLEW_1_28_6,document.getElementById("XLEW_1_29_6").value=eeisnumber(co.XLEW_1_29_6)?eedisplayFloat(co.XLEW_1_29_6):co.XLEW_1_29_6,document.getElementById("XLEW_1_30_6").value=eeisnumber(co.XLEW_1_30_6)?eedisplayFloat(co.XLEW_1_30_6):co.XLEW_1_30_6,document.getElementById("XLEW_1_31_6").value=eeisnumber(co.XLEW_1_31_6)?eedisplayFloat(co.XLEW_1_31_6):co.XLEW_1_31_6,document.getElementById("XLEW_1_32_6").value=eedisplayFloat(co.XLEW_1_32_6),document.getElementById("XLEW_1_33_6").value=eedisplayFloat(co.XLEW_1_33_6),document.getElementById("XLEW_1_34_6").value=eedisplayFloat(co.XLEW_1_34_6),document.getElementById("XLEW_1_35_6").value=eedisplayFloat(co.XLEW_1_35_6),document.getElementById("XLEW_1_36_6").value=eeisnumber(co.XLEW_1_36_6)?eedisplayFloat(co.XLEW_1_36_6):co.XLEW_1_36_6,document.getElementById("XLEW_1_37_6").value=eedisplayFloat(co.XLEW_1_37_6),document.getElementById("XLEW_1_38_6").value=eedisplayFloat(co.XLEW_1_38_6),document.getElementById("XLEW_1_39_6").value=eedisplayFloat(co.XLEW_1_39_6),document.getElementById("XLEW_1_40_6").value=eedisplayFloat(co.XLEW_1_40_6),document.getElementById("XLEW_1_41_6").value=eedisplayFloat(co.XLEW_1_41_6),document.getElementById("XLEW_1_42_6").value=eedisplayFloat(co.XLEW_1_42_6),document.getElementById("XLEW_1_43_6").value=eedisplayFloat(co.XLEW_1_43_6),document.getElementById("XLEW_1_44_6").value=eedisplayFloat(co.XLEW_1_44_6),document.getElementById("XLEW_1_45_6").value=eedisplayFloat(co.XLEW_1_45_6),document.getElementById("XLEW_1_46_6").value=eedisplayFloat(co.XLEW_1_46_6),document.getElementById("XLEW_1_47_6").value=eedisplayFloat(co.XLEW_1_47_6),document.getElementById("XLEW_1_48_6").value=eedisplayFloat(co.XLEW_1_48_6),document.getElementById("XLEW_1_49_6").value=eedisplayFloat(co.XLEW_1_49_6),document.getElementById("XLEW_1_50_6").value=eedisplayFloat(co.XLEW_1_50_6),document.getElementById("XLEW_1_51_6").value=eedisplayFloat(co.XLEW_1_51_6),document.getElementById("XLEW_1_52_6").value=eedisplayFloat(co.XLEW_1_52_6),document.getElementById("XLEW_1_53_6").value=eedisplayFloat(co.XLEW_1_53_6),document.getElementById("XLEW_1_54_6").value=eedisplayFloat(co.XLEW_1_54_6),document.getElementById("XLEW_1_55_6").value=eedisplayFloat(co.XLEW_1_55_6),document.getElementById("XLEW_1_56_6").value=eedisplayFloat(co.XLEW_1_56_6),document.getElementById("XLEW_1_57_6").value=eedisplayFloat(co.XLEW_1_57_6),document.getElementById("XLEW_1_58_6").value=eedisplayFloat(co.XLEW_1_58_6),document.getElementById("XLEW_1_59_6").value=eedisplayFloat(co.XLEW_1_59_6),document.getElementById("XLEW_1_60_6").value=eedisplayFloat(co.XLEW_1_60_6),document.getElementById("XLEW_1_61_6").value=eedisplayFloat(co.XLEW_1_61_6),document.getElementById("XLEW_1_62_6").value=eedisplayFloat(co.XLEW_1_62_6),document.getElementById("XLEW_1_63_6").value=eedisplayFloat(co.XLEW_1_63_6),document.getElementById("XLEW_1_64_6").value=eedisplayFloat(co.XLEW_1_64_6),document.getElementById("XLEW_1_65_6").value=eedisplayFloat(co.XLEW_1_65_6),document.getElementById("XLEW_1_66_6").value=eedisplayFloat(co.XLEW_1_66_6),document.getElementById("XLEW_1_67_6").value=eedisplayFloat(co.XLEW_1_67_6),document.getElementById("XLEW_1_69_6").value=eedisplayFloat(co.XLEW_1_69_6),document.getElementById("XLEW_1_70_6").value=eedisplayFloat(co.XLEW_1_70_6),document.getElementById("XLEW_1_71_6").value=eedisplayFloat(co.XLEW_1_71_6),document.getElementById("XLEW_1_72_6").value=eedisplayFloat(co.XLEW_1_72_6),document.getElementById("XLEW_1_73_6").value=eedisplayFloat(co.XLEW_1_73_6),document.getElementById("XLEW_1_74_6").value=eedisplayFloat(co.XLEW_1_74_6),document.getElementById("XLEW_1_75_6").value=eedisplayFloat(co.XLEW_1_75_6),document.getElementById("XLEW_1_76_6").value=eedisplayFloat(co.XLEW_1_76_6),document.getElementById("XLEW_1_77_6").value=eedisplayFloat(co.XLEW_1_77_6),document.getElementById("XLEW_1_78_6").value=eedisplayFloat(co.XLEW_1_78_6),document.getElementById("XLEW_1_79_6").value=eedisplayFloat(co.XLEW_1_79_6),document.getElementById("XLEW_1_80_6").value=eedisplayFloat(co.XLEW_1_80_6),document.getElementById("XLEW_1_81_6").value=eedisplayFloat(co.XLEW_1_81_6),document.getElementById("XLEW_1_82_6").value=eedisplayFloat(co.XLEW_1_82_6),document.getElementById("XLEW_1_83_6").value=eedisplayFloat(co.XLEW_1_83_6),document.getElementById("XLEW_1_84_6").value=eedisplayFloat(co.XLEW_1_84_6),document.getElementById("XLEW_1_85_6").value=eedisplayFloat(co.XLEW_1_85_6),document.getElementById("XLEW_1_87_6").value=eedisplayFloat(co.XLEW_1_87_6),document.getElementById("XLEW_1_88_6").value=eedisplayFloat(co.XLEW_1_88_6),document.getElementById("XLEW_1_89_6").value=eedisplayFloat(co.XLEW_1_89_6),document.getElementById("XLEW_1_90_6").value=eedisplayFloat(co.XLEW_1_90_6),document.getElementById("XLEW_1_91_6").value=eedisplayFloat(co.XLEW_1_91_6),document.getElementById("XLEW_1_92_6").value=eedisplayFloat(co.XLEW_1_92_6),document.getElementById("XLEW_1_93_6").value=eedisplayFloat(co.XLEW_1_93_6),document.getElementById("XLEW_1_94_6").value=eedisplayFloat(co.XLEW_1_94_6),document.getElementById("XLEW_1_95_6").value=eedisplayFloat(co.XLEW_1_95_6),document.getElementById("XLEW_1_96_6").value=eedisplayFloat(co.XLEW_1_96_6),document.getElementById("XLEW_1_97_6").value=eedisplayFloat(co.XLEW_1_97_6),document.getElementById("XLEW_1_98_6").value=eedisplayFloat(co.XLEW_1_98_6),document.getElementById("XLEW_1_99_6").value=eedisplayFloat(co.XLEW_1_99_6),document.getElementById("XLEW_1_100_6").value=eedisplayFloat(co.XLEW_1_100_6),document.getElementById("XLEW_1_101_6").value=eedisplayFloat(co.XLEW_1_101_6),document.getElementById("XLEW_1_102_6").value=eedisplayFloat(co.XLEW_1_102_6),document.getElementById("XLEW_1_103_6").value=eedisplayFloat(co.XLEW_1_103_6),document.getElementById("XLEW_1_104_6").value=eedisplayFloat(co.XLEW_1_104_6),document.getElementById("XLEW_1_105_6").value=eedisplayFloat(co.XLEW_1_105_6),document.getElementById("XLEW_1_106_6").value=eedisplayFloat(co.XLEW_1_106_6),document.getElementById("XLEW_1_107_6").value=eedisplayFloat(co.XLEW_1_107_6)}function str_eq(e,_){return isNaN(e)&&isNaN(_)?e.toLowerCase()==_.toLowerCase():e==_}function str_le(e,_){return isNaN(e)&&isNaN(_)?e.toLowerCase()<=_.toLowerCase():_>=e}function var_eq(e,_){var t=mytypeof(e),a=mytypeof(_);if(t!=a)return!1;switch(t){case 1:case 3:return e==_;case 2:return str_eq(e,_);default:return!1}}function var_le(e,_){var t=mytypeof(e),a=mytypeof(_);if(t!=a)return a>=t;switch(t){case 1:case 3:return _>=e;case 2:return str_le(e,_);default:return!1}}function mytypeof(e){switch(typeof e){case"number":return myIsNaN(e)?4:1;case"string":return 2;case"boolean":return 3;case"object":return e.constructor==Number?myIsNaN(e)?4:1:e.constructor==String?2:e.constructor==Boolean?3:4;default:return 4}}function myIsNaN(e){return isNaN(e)||"number"==typeof e&&!isFinite(e)}function round(e,_){if(isFinite(e)&&isFinite(_)){var t=0>e?-1:1,a=Math.abs(e),o=Math.pow(10,_);return t*Math.round(a*o)/o}return NaN}function sum2(e,_,t){for(var a=0,o=_;t>=o;o++)a+=e[o];return a}function sum3(e,_,t,a,o){for(var l=0,n=_;a>=n;n++)for(var c=t;o>=c;c++)l+=e[n][c];return l}function sumgeneral(e,_,t,a){for(var o=_,l=0;l<a.length;l++)o+=sum3(a[l][0],a[l][1],a[l][2],a[l][3],a[l][4]);return o}function andgeneral(e,_,t,a){if(!_)return!1;for(var o=0;o<a.length;o++)for(var l=a[o][0],n=a[o][1];n<=a[o][3];n++)for(var c=a[o][2];c<=a[o][4];c++)if(!l[n][c])return!1;return!0}function orgeneral(e,_,t,a){if(_)return!0;for(var o=0;o<a.length;o++)for(var l=a[o][0],n=a[o][1];n<=a[o][3];n++)for(var c=a[o][2];c<=a[o][4];c++)if(l[n][c])return!0;return!1}function s2n(e){e=String(e).replace(eedecreg,"."),e=e.replace(eethreg,""),e=e.replace(eecurrencyreg,"");var _=parseFloat(e);return myIsNaN(_)&&(_=0),e.search(eepercentreg)>=0&&(_/=100),_}function b2s(e){return e?eetrue:eefalse}function v2n(e){switch(typeof e){case"number":return e;case"string":return s2n(e);case"boolean":return e?1:0;case"object":return e.constructor==Number?e:e.constructor==String?s2n(e):e.constructor==Boolean?e?1:0:Number.NaN;default:return Number.NaN}}function eeparseFloat(e){e=String(e).replace(eedecreg,".");var _=parseFloat(e);return isNaN(_)?0:_}function eedisplayFloat(e){if(myIsNaN(e))return Number.NaN;var _=String(e);return near0RegExp.test(_)&&(e=round(e,8),_=String(e)),_.replace(/\./g,eedec)}function eedisplayFloatV(e){return""==e?e:isFinite(e)?eedisplayFloat(e):e}function eedisplayFloatND(e,_){if(myIsNaN(e))return Number.NaN;var t=round(e,_);if(_>0){var a=String(t);if(-1!=a.indexOf("e"))return a;if(-1!=a.indexOf("E"))return a;var o=a.split(".");if(o.length<2){var l="00000000000000".substring(0,_);return o[0].toString()+eedec+l}var l=(o[1].toString()+"00000000000000").substring(0,_);return o[0].toString()+eedec+l}return t}function eeparseFloatV(e){if(""==e)return e;if(e=String(e).replace(eedecreg,"."),!eeparseFloatVreg.test(e))return e;var _=parseFloat(e);return isNaN(_)?e:_}function eedisplayFloatNDV(e,_){return""==e?e:isFinite(e)?eedisplayFloatND(e,_):e}function eeisstring(e){switch(typeof e){case"string":return!0;case"object":return e.constructor==String;default:return!1}}function eeisnumber(e){if(null==e||isNaN(e)||e==Number.NEGATIVE_INFINITY||e==Number.POSITIVE_INFINITY)return!1;switch(typeof e){case"number":return!0;case"object":return e.constructor==Number;default:return!1}}function postcode(){}function TriggerOnchange(e){var _=jQuery.Event("change");$("#"+e).trigger(_)}function submitClick(e){if(focused=!1,ssc.asyncRecalc=!1,recalc_onclick("submit"),ssc.asyncRecalc=!0,ssc.pendingUploads>0)return alert("Please wait until all attachments have finished uploading."),!1;var _=$(".error").filter(":hiddenByParent").length;if(_>0)return showValidateMessage(ssc.exMsg+" : "+_+(_>1?" errors":" error"),"Form validation"),"function"==typeof ssc.focusOnElement&&ssc.focusOnElement($(".error").first()),!1;var t=[];$("input:file").each(function(e,_){var a=$(this).data("files");t=t.concat(a)});for(var a=t.length,o=0;a>o;o++)$("#formc").append("<input type='hidden' id='"+["xll_fileid"+o]+"' name='"+["xll_fileid"+o]+"' value='"+t[o].id+"'/>");$("#formc").submit()}function printAllClick(){if(void 0!=ssc.utils){window.ps=!1;var e=ssc.utils.checkIfFileURI();if(e)return void $("#printall-fromfile-modal").modal("show");recalc_onclick(""),$("#printAllTheme").length||$("head").append("<style id='printAllTheme' type='text/css'>@media print{.panel-default .panel-collapse,.tab-content .tab-pane:not(.hide-printsheet){display:block!important}a{color:inherit;text-decoration:none!important}a:link,a:visited{text-decoration:none}body{background:#fff;color:#000;font:11pt}.tab-pane{page-break-after:always}.tab-pane:last-child{page-break-after:auto}.panel-collapse{page-break-after:always!important}.panel-collapse:last-child{page-break-after:auto}.panel-heading,.jw-header{display:none!important}.jw-step{display:block!important;page-break-after:always}.navbar-default{display:none!important;}}</style>"),window.print(),$("#printAllTheme").remove()}else console.log("Printall does not work in file system, please upload your converted page.")}function LoadFromQueryString(){var e=decodeURI(document.location.search),_=!1;e.indexOf("_readonly")>-1&&(_=!0),e.length>0&&$.each(e.substr(1).split("&"),function(e,_){var t=_.split("=");if(2==t.length){var a=t[0].toString(),o=t[1].toString();ssc.formBinder.bind(a,o)}})}function navigate(e){var _=e.keyCode|e.which;if(13==_||40==_||38==_){var t=$(e.target||e.srcElement);if(!t.is("textarea")&&(!t.is("select")||38!=_&&40!=_)){for(var a=parseInt(t.attr("data-sheet"),10),o=parseInt(t.attr("data-row"),10),l=parseInt(t.attr("data-col"),10),n=!1,c=$("#sheet-"+a),E='input:not(":hidden,:button,[readonly=readonly],:disabled"),select,a.ui-slider-handle,textarea',d=o+1,u=o-1,r=d,s=u;40==_&&r>=d||38==_&&u>=s;){var m=c.find(E).filter("[data-sheet="+a+"][data-row="+(38==_?u:d)+"][data-col="+l+"]");if(m.length>0){m.focus(),m.is("input:text, textarea")&&m.select(),n=!0;break}var L;void 0==c.data("col"+l)?(L=c.find(E).filter("[data-sheet="+a+"][data-col="+l+"]").map(function(){return parseInt($(this).attr("data-row"),10)}).toArray(),c.data("col"+l,L)):L=c.data("col"+l),r=L[L.length-1],s=L[0];var W="indexOf"in Array.prototype?L.indexOf(o):$.inArray(o,L);if(40==_&&r>o)d=L[W+1];else{if(!(38==_&&o>s))break;u=L[W-1]}}if(!n){var X;X=38==_?parseInt(t.attr("tabindex"),10)-1:parseInt(t.attr("tabindex"),10)+1;var i=c.find(E).filter("[data-sheet][data-row][data-col][tabindex="+X+"]");if(i.length>0)i.is(":radio")&&(i=i.filter(":checked")),i.length>0&&(i.focus(),i.is("input:text, textarea")&&i.select());else{var y=c.find(E).filter("[data-sheet][data-row][data-col][tabindex]:first");y.focus(),y.is("input:text, textarea")&&y.select()}}e.preventDefault?e.preventDefault():e.returnValue=!1}}}function calendarCallback(e){var _=$("#"+e.id).data("caltype"),t="popup"==_?e.id:"cal_"+e.id,a=$("#"+t),o=e.s1;void 0===a.data("is-dirty")&&(""==o||isNaN(o)||(a.datepicker("update",new Date(year(o),eemonth(o)-1,eeday(o))),EE.eeRecalcNeeded=!0))}function showValidateMessage(e,_){toastr?_&&_.length>0?toastr.error(e,_):toastr.error(e):alert(e)}function resetClick(){void 0!==ssc&&void 0!==ssc.realtimesync&&void 0!==ssc.realtimesync.connection&&(ssc.realtimesync.connection.close(),ssc.realtimesync.connected=!1,ssc.realtimesync.ShowDisconnectAlert($(".toolbar-panel-right"))),document.formc.reset(),postcode(),LoadFromQueryString(),recalc_onclick("reset")}var eeisus=1,eetrue="TRUE",eefalse="FALSE",eedec=".",eeth=",",eedecreg=new RegExp("\\.","g"),eethreg=new RegExp(",","g"),eecurrencyreg=new RegExp("[$]","g"),eepercentreg=new RegExp("%","g"),co=new Object,near0RegExp=new RegExp("[.](.*0000000|.*9999999)"),eeparseFloatVreg=new RegExp("^ *-?[0-9.]+ *$");jQuery.expr[":"].hiddenByParent=function(e){if(e.id.startsWith("xl_"))return!0;var _=!1,t=$(e);return void 0!=t&&(_="none"!=t.closest("tr[class^='_css']").css("display")),1==_&&(_="none"!=t.closest(".tab-pane>div").css("display")),_};var ssccf1n=function(e,_,t,a){switch(e){case"image":$("#"+_).attr("src",$("#"+a).attr("src"))}},ssccf4n=function(e,_,t,a,o,l,n){},ssc=ssc||{};ssc.pendingUploads=0,ssc.recalcSource="",ssc.APPNAME="Pediatric_Resuscitation1",ssc.exMsg="The fields with the red border are required or invalid.",$(window).on("scroll",function(){var e=$(window);$(".position-fixed-x").css("left",e.scrollLeft()),$(".position-fixed-y").css("top",e.scrollTop())}),ssc.Dialog={},ssc.Dialog.BeforeSubmitDesc="The form is being submitted.",ssc.Dialog.OfflineHeading="Save until online",ssc.Dialog.OfflineDesc="You are currently offline and the submit failed. Do you want to save the submit and send it later when you are online.",ssc.Dialog.OfflineConfirm="Do you want to save?",ssc.Dialog.OfflineSubmitHeading="Offline forms submit confirmation",ssc.Dialog.OfflineSubmitDesc="There are Offline form(s), which are now ready to submit in server.",ssc.Dialog.OfflineSubmitConfirm="Do you want to submit?",ssc.Dialog.FailOfflineHeading="Offline Form submit failed",ssc.Dialog.FailOfflineDesc="Unable to connect to the Internet. Please try submitting the offline forms later in internet connection.",ssc.Dialog.OfflineSubmitWait="It may take sometime to finish all submits depending on the size of offline forms and internet connection.",ssc.Dialog.OfflineSubmitWaitCounter="Left";var focused=!1;!function(e){postcode(),ssc.active_sheet_selector="div.active > div.container-fluid.ssc-responsive-sheet > div.row > section",e("a").on("click",function(_){var t=e(this).attr("href");if("#"==t.slice(0,1)){if(_.preventDefault(),"#"==t)return;var a=e(t);if(0==a.length)return void alert("Oops! This link is broken so can not navigate.");
focused=!1,ssc.focusOnElement(a)}}),ssc.focusOnElement=function(_){if(!focused){focused=!0;var t=_.parents(".tab-pane");t.hasClass("active")||e('.nav-tabs a[href="#'+t.attr("id")+'"]').tab("show"),e("html, body").stop().animate({scrollTop:_.offset().top-40},900,"swing",function(){_.focus()})}},e(".btn.btn-sm.button-submit.spin-button").on("click",function(){return submitClick(this),!1}),e(".btn.btn-sm.button-reset").on("click",function(){return resetClick(this),!1}),e(".btn.btn-sm.button-update").on("click",function(){return recalc_onclick(""),!1}),e(".btn.btn-sm.button-print.all").on("click",function(){return printAllClick(this),!1}),e("#trialDialog").modal("show");var _=e('input:not(":hidden,:button,[readonly=readonly],:disabled"),select,a.ui-slider-handle,textarea,a.ui-state-active');void 0!=_&&0==_.filter(":first").hasClass("form-control")&&_.filter(":first").focus(),e("textarea[readonly],input[type=text][readonly]").css("background","transparent")}($),ssc.checkIfMSIE=function(){var e=window.navigator.userAgent,_=e.indexOf("MSIE "),t=e.indexOf(".NET CLR");return!(-1===_&&-1===t)};